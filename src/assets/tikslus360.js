...
$(window).load(function(){  
   ...
   $("#view360").tikslus360({imageDir:'./src/assets/car360/',imageCount:36,imageExt:'png' ,canvasID:'mycar',canvasWidth:900,canvasHeight:350,autoRotate:false});
 });